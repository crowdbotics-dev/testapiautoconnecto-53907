...
## Project Structure
    ...
    ├── testapiautoconnecto_53907  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_53907`
...
2. Clone this repo and `cd testapiautoconnecto_53907`
